...
const Footer = () => {
  return (
    <footer className="bg-slate-900 dark:bg-slate-950 text-white border-t border-slate-200 dark:border-slate-800">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <Hammer className="h-8 w-8 text-amber-400 dark:text-amber-300" />
            ...
            <div className="flex items-center space-x-2 text-amber-400 dark:text-amber-300">
          ...
          <div>
            ...
            <div className="space-y-2 text-slate-400 dark:text-slate-300">
              <p>Lunedì - Venerdì: 8:00 - 18:00</p>
              <p>Sabato: 8:00 - 12:00</p>
              <p>Domenica: Solo emergenze</p>
              <p className="text-amber-400 dark:text-amber-300 font-semibold">Pronto Intervento: 24/7</p>
            </div>
          </div>
        </div>

        <div className="border-t border-slate-800 dark:border-slate-700 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-slate-400 dark:text-slate-300 text-sm">
              © 2024 Fabbro Rossi. Tutti i diritti riservati.
            </div>
            
            <div className="flex flex-wrap justify-center md:justify-end space-x-6 text-sm text-slate-400 dark:text-slate-300">
          ...
          <div className="mt-4 text-center md:text-right text-xs text-slate-500 dark:text-slate-400">

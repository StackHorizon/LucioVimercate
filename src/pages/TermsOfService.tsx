        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-20">
            <h1 className="text-5xl font-bold text-slate-900 dark:text-white mb-6">
              Termini e <span className="bg-gradient-to-r from-amber-600 to-orange-600 bg-clip-text text-transparent">Condizioni</span>
            </h1>
            <p className="text-xl text-slate-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed">
              Benvenuto sul nostro sito web. Ti invitiamo a leggere attentamente questi Termini e Condizioni prima di utilizzare i nostri servizi professionali
            </p>
          ...
          <div className="max-w-6xl mx-auto">
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg">
                ...
                <div className="space-y-4 text-slate-700 dark:text-slate-300">
                  <p className="leading-relaxed">
                    Accedendo e utilizzando i servizi di <strong>Fabbro Luciano Vimercate</strong>, accetti i seguenti Termini e Condizioni. 
                    Se non sei d'accordo con queste condizioni, ti invitiamo a non utilizzare il nostro sito web.
                  </p>
                  <p className="leading-relaxed">
                    L'utilizzo dei nostri servizi implica l'accettazione integrale di tutti i termini e condizioni qui riportati, 
            ...
            <section className="mb-16">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg">
                ...
                <div className="bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/30 dark:to-orange-950/30 p-6 rounded-xl border border-amber-200 dark:border-amber-800">
                  <div className="space-y-4 text-slate-700 dark:text-slate-300">
                    <p className="leading-relaxed">
                      <strong>Fabbro Luciano</strong> si riserva il diritto di modificare questi Termini e Condizioni 
                      in qualsiasi momento per adeguarli alle normative vigenti o ai cambiamenti dei servizi offerti.
                    </p>
                    <p className="leading-relaxed">
                      Le modifiche saranno pubblicate su questa pagina e diventeranno effettive immediatamente dopo la pubblicazione. 
                      Ti invitiamo a verificare periodicamente questa pagina per restare aggiornato sulle eventuali modifiche.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/30 dark:to-green-900/30 p-6 rounded-xl border border-green-200 dark:border-green-800">
                    <h3 className="text-xl font-semibold text-green-800 dark:text-green-300 mb-4">✅ Uso Consentito</h3>
                  ...
                  <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/30 dark:to-red-900/30 p-6 rounded-xl border border-red-200 dark:border-red-800">
                    <h3 className="text-xl font-semibold text-red-800 dark:text-red-300 mb-4">❌ Uso Vietato</h3>
                    <ul className="space-y-2 text-slate-700 dark:text-slate-300 text-sm">
            ...
            <section className="mb-16">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg">
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/30 dark:to-purple-900/30 p-6 rounded-xl border border-purple-200 dark:border-purple-800">
                  <div className="space-y-4 text-slate-700 dark:text-slate-300">
                    <p className="leading-relaxed">
                      Tutti i contenuti del sito web di <strong>Fabbro Luciano</strong> sono di proprietà dell'azienda.
                    </p>
                    <p className="leading-relaxed">
                      <strong>È vietata la riproduzione, distribuzione o utilizzo non autorizzato di qualsiasi materiale presente sul sito.</strong>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <section className="mb-16">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-lg">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/30 dark:to-red-900/30 p-6 rounded-xl border border-red-200 dark:border-red-800">
                    <h3 className="text-lg font-semibold text-red-800 dark:text-red-300 mb-3">🚫 Esclusioni</h3>
                    <ul className="space-y-2 text-slate-700 dark:text-slate-300 text-sm">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/30 dark:to-blue-900/30 p-6 rounded-xl border border-blue-200 dark:border-blue-800">
                    <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-300 mb-3">📋 Limitazioni</h3>
                    <p className="text-slate-700 dark:text-slate-300 text-sm leading-relaxed">
                      <strong>Fabbro Luciano Vimercate</strong> non sarà responsabile per danni diretti, indiretti, 
                      incidentali, speciali o consequenziali derivanti dall'uso del sito web, fatta salva la responsabilità 
                      per i servizi di fabbro effettivamente prestati.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="inline-block bg-white dark:bg-slate-700 px-6 py-4 rounded-xl border border-amber-200 dark:border-amber-700 shadow-lg">
                      <div className="flex items-center justify-center space-x-3">
                        ...
                        <div className="text-left">
                          ...
                          <a href="tel:3293285783" className="text-xl font-bold text-amber-600 dark:text-amber-400 hover:underline">
                            329 328 5783
                          </a>
                        </div>
                      </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white dark:bg-slate-700 p-4 rounded-xl border border-amber-200 dark:border-amber-700">
                      <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                        Per chiarimenti sui termini e condizioni, reclami o segnalazioni, contattaci durante gli orari di servizio. 
